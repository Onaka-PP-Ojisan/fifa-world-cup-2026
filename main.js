...
const SCHEDULE_DAYS = [
  ...
  {key:'d627',label:'6/27 土',matches:[
    {time:'4:00',grp:'I',jp:false,teams:'ノルウェー vs フランス',venue:'ボストン・スタジアム',note:'DAZN',score:'1-4',scorers:{'ノルウェー':['テロ・アースガード 20\''],'フランス':['ウスマン・デンベレ 7\'','ウスマン・デンベレ 20\'','ウスマン・デンベレ 32\'','デジレ・ドゥエ 90\'+3\'']}},
    {time:'4:00',grp:'I',jp:false,teams:'セネガル vs イラク',venue:'トロント・スタジアム',note:'DAZN',score:'5-0',scorers:{'セネガル':['アビブ・ディアラ 4\'','イスマイラ・サール 56\'','パペ・ゲイェ 59\'','パペ・ゲイェ 71\'','イリマン・エンディアイエ 82\''],'イラク':[]}},
    {time:'9:00',grp:'H',jp:false,teams:'カーボベルデ vs サウジアラビア',venue:'ヒューストン・スタジアム',note:'DAZN',score:'0-0',scorers:{'カーボベルデ':[],'サウジアラビア':[]}},
    {time:'9:00',grp:'H',jp:false,teams:'ウルグアイ vs スペイン',venue:'グアダラハラ・スタジアム',note:'DAZN',score:'0-1',scorers:{'ウルグアイ':[],'スペイン':['アレックス・バエナ 42\'']}},
    {time:'12:00',grp:'G',jp:false,teams:'ニュージーランド vs ベルギー',venue:'BCプレイス（バンクーバー）',note:'DAZN',score:'1-5',scorers:{'ニュージーランド':['エライジャ・ジャスト 84\''],'ベルギー':['レアンドロ・トロサール 28\'','レアンドロ・トロサール 50\'','ケビン・デ・ブライネ 66\'','ロメル・ルカク 86\'','アレクシス・サーレマーケルス 90\'+4\'']}},
    {time:'12:00',grp:'G',jp:false,teams:'エジプト vs イラン',venue:'シアトル・スタジアム',note:'DAZN',score:'1-1',scorers:{'エジプト':['マフムード・サベル 5\''],'イラン':['ラミン・レザエイアン 14\'']}},
  ]},
  {key:'d628',label:'6/28 日',matches:[
    {time:'6:00',grp:'L',jp:false,teams:'パナマ vs イングランド',venue:'NY/NJ・スタジアム',note:'DAZN',score:'0-2',scorers:{'パナマ':[],'イングランド':['ジュード・ベリンガム 62\'','ハリー・ケイン 67\'']}},
    {time:'6:00',grp:'L',jp:false,teams:'クロアチア vs ガーナ',venue:'フィラデルフィア・スタジアム',note:'DAZN',score:'2-1',scorers:{'クロアチア':['ペタル・スチッチ 31\'','ニコラ・ヴラシッチ 83\''],'ガーナ':['デリック・ルカッセン 73\'']}},
    {time:'8:30',grp:'K',jp:false,teams:'コロンビア vs ポルトガル',venue:'マイアミ・スタジアム',note:'DAZN',score:'0-0',scorers:{'コロンビア':[],'ポルトガル':[]}},
    {time:'8:30',grp:'K',jp:false,teams:'コンゴDR vs ウズベキスタン',venue:'アトランタ・スタジアム',note:'DAZN',score:'3-1',scorers:{'コンゴDR':['ヨアヌ・ウィサ 68\' PK','フィストン・マイェレ 78\'','ヨアヌ・ウィサ 90\'+1\''],'ウズベキスタン':['エルドル・ショムロドフ 10\'']}},
    {time:'11:00',grp:'J',jp:false,teams:'アルジェリア vs オーストリア',venue:'カンザスシティ・スタジアム',note:'DAZN',score:'3-3',scorers:{'アルジェリア':['ファレス・ベルガリ 41\'','リヤド・マフレズ 60\'','リヤド・マフレズ 90\'+3\''],'オーストリア':['マルコ・アルナウトビッチ 28\'','マルセル・ザビッツァー 55\'','サシャ・カライジッチ 90\'+5\'']}},
  ...
  {key:'d702',label:'7/2 木',matches:[
    {time:'1:00',grp:'R32',jp:false,teams:'イングランド vs コンゴDR',venue:'フィラデルフィア・スタジアム',note:'DAZN',score:'2-1',scorers:{'コンゴDR':["ブライアン・チペンガ 7'"],'イングランド':["ハリー・ケイン 75'","ハリー・ケイン 86'"]}},
    {time:'5:00',grp:'R32',jp:false,teams:'ベルギー vs セネガル',venue:'シアトル・スタジアム',note:'DAZN（延長後ティーレマンスPKでベルギー逆転）',score:'3-2',scorers:{'セネガル':["アビブ・ディアラ 24'","イスマイラ・サール"],'ベルギー':["ロメル・ルカク 86'","ユーリ・ティーレマンス 89'","ユーリ・ティーレマンス 125' PK"]}},
  ...
  {key:'d705',label:'7/5 日',matches:[
    {time:'2:00',grp:'R16',jp:false,teams:'🇨🇦 カナダ vs モロッコ 🇲🇦',venue:'ロサンゼルス・スタジアム',note:'DAZN',score:'0-3',scorers:{'カナダ':[],'モロッコ':["アッゼディン・ウナヒ 50'","アッゼディン・ウナヒ 82'","スフィアン・ラヒミ 90'+8"]}},
    {time:'6:00',grp:'R16',jp:false,teams:'🇵🇾 パラグアイ vs フランス 🇫🇷',venue:'ダラス・スタジアム',note:'DAZN',score:'0-1',scorers:{'パラグアイ':[],'フランス':["キリアン・エムバペ 70' PK"]}},
  ]},
  {key:'d706',label:'7/6 月',matches:[
    {time:'5:00',grp:'R16',jp:false,teams:'🇧🇷 ブラジル vs ノルウェー 🇳🇴',venue:'アトランタ・スタジアム',note:'DAZN',score:'1-2',scorers:{'ブラジル':["ネイマール 90'+10' PK"],'ノルウェー':["アーリング・ハーランド 79'","アーリング・ハーランド 90'"]}},
  ...
  {key:'d715',label:'7/15 水',matches:[
    {time:'4:00',grp:'準決勝',jp:false,teams:'🇫🇷 フランス vs スペイン 🇪🇸',venue:'アトランタ・スタジアム',note:'DAZN',score:'0-2',scorers:{'スペイン':["ミケル・オジャルサバル 22'(PK)","ペドロ・ポロ 58'"]}},
  ]},
...
const bracketData = {
  r32: [
    ...
    {id:'r32_10',label:'R32-10（M82）',date:'7/2（木）5:00',
     t1:{name:'ベルギー',flag:'🇧🇪',score:'3',win:true},t2:{name:'セネガル',flag:'🇸🇳',score:'2'}},
...
function computeStandings(){
  ...
  const groupStageIds = new Set(['A','B','C','D','E','F','G','H','I','J','K','L']);
  SCHEDULE_DAYS.forEach(day=>day.matches.forEach(m=>{
    if(!groupStageIds.has(m.grp)) return; // 決勝トーナメントの試合は除外
    if(!m.score) return;
